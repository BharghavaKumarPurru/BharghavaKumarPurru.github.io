    ...
    case "recruiter":
      return {
        ...
        hero: {
          ...
          description:
            "Experienced .NET Developer with 3 years in designing websites, RESTful services, and responsive web applications. MS Computer Science graduate from Case Western Reserve University with proven leadership as CTO.",
          stats: [
